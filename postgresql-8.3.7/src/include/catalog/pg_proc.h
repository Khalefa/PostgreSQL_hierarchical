...
DATA(insert OID = 3001 (  hr_build		   PGNSP PGUID 12 1 0 f f t f v 3 2281 "2281 2281 2281" _null_ _null_ _null_ hr_build - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3002 (  hr_insert		   PGNSP PGUID 12 1 0 f f t f v 6 16 "2281 2281 2281 2281 2281 2281" _null_ _null_ _null_	hr_insert - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3003 (  hr_bulkdelete	   PGNSP PGUID 12 1 0 f f t f v 4 2281 "2281 2281 2281 2281" _null_ _null_ _null_ hr_bulkdelete - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3004 (  hr_vacuumcleanup   PGNSP PGUID 12 1 0 f f t f v 2 2281 "2281 2281" _null_ _null_ _null_ hr_vacuumcleanup - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3005 (  hr_costestimate   PGNSP PGUID 12 1 0 f f t f v 8 2278 "2281 2281 2281 2281 2281 2281 2281 2281" _null_ _null_ _null_  hr_costestimate - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3006 (  hr_options		   PGNSP PGUID 12 1 0 f f t f s 2 17 "1009 16" _null_ _null_ _null_  hr_options - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3007 (  hr_gettuple		   PGNSP PGUID 12 1 0 f f t f v 2 16 "2281 2281" _null_ _null_ _null_  hr_gettuple - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3008 (  hr_getmulti		   PGNSP PGUID 12 1 0 f f t f v 4 16 "2281 2281 2281 2281" _null_ _null_ _null_  hr_getmulti - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3009 (  hr_beginscan	   PGNSP PGUID 12 1 0 f f t f v 3 2281 "2281 2281 2281" _null_ _null_ _null_	hr_beginscan - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3010 (  hr_rescan		   PGNSP PGUID 12 1 0 f f t f v 2 2278 "2281 2281" _null_ _null_ _null_ hr_rescan - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3011 (  hr_endscan		   PGNSP PGUID 12 1 0 f f t f v 1 2278 "2281" _null_ _null_ _null_	hr_endscan - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3012 (  hr_markpos		   PGNSP PGUID 12 1 0 f f t f v 1 2278 "2281" _null_ _null_ _null_	hr_markpos - _null_ _null_ ));
DESCR("Hierarchical(internal)");

DATA(insert OID = 3013 (  hr_restrpos		   PGNSP PGUID 12 1 0 f f t f v 1 2278 "2281" _null_ _null_ _null_	hr_restrpos - _null_ _null_ ));
DESCR("Hierarchical(internal)");

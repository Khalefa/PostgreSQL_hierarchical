...
/*
 *	hierarchical integer_ops
 */

/* default operators int2 */
DATA(insert (	3024   21 21 1 f  95	3000 ));
DATA(insert (	3024   21 21 2 f  522	3000 ));
DATA(insert (	3024   21 21 3 f  94	3000 ));
DATA(insert (	3024   21 21 4 f  524	3000 ));
DATA(insert (	3024   21 21 5 f  520	3000 ));
/* crosstype operators int24 */
DATA(insert (	3024   21 23 1 f  534	3000 ));
DATA(insert (	3024   21 23 2 f  540	3000 ));
DATA(insert (	3024   21 23 3 f  532	3000 ));
DATA(insert (	3024   21 23 4 f  542	3000 ));
DATA(insert (	3024   21 23 5 f  536	3000 ));
/* crosstype operators int28 */
DATA(insert (	3024   21 20 1 f  1864	3000 ));
DATA(insert (	3024   21 20 2 f  1866	3000 ));
DATA(insert (	3024   21 20 3 f  1862	3000 ));
DATA(insert (	3024   21 20 4 f  1867	3000 ));
DATA(insert (	3024   21 20 5 f  1865	3000 ));
/* default operators int4 */
DATA(insert (	3024   23 23 1 f  97	3000 ));
DATA(insert (	3024   23 23 2 f  523	3000 ));
DATA(insert (	3024   23 23 3 f  96	3000 ));
DATA(insert (	3024   23 23 4 f  525	3000 ));
DATA(insert (	3024   23 23 5 f  521	3000 ));
/* crosstype operators int42 */
DATA(insert (	3024   23 21 1 f  535	3000 ));
DATA(insert (	3024   23 21 2 f  541	3000 ));
DATA(insert (	3024   23 21 3 f  533	3000 ));
DATA(insert (	3024   23 21 4 f  543	3000 ));
DATA(insert (	3024   23 21 5 f  537	3000 ));
/* crosstype operators int48 */
DATA(insert (	3024   23 20 1 f  37	3000 ));
DATA(insert (	3024   23 20 2 f  80	3000 ));
DATA(insert (	3024   23 20 3 f  15	3000 ));
DATA(insert (	3024   23 20 4 f  82	3000 ));
DATA(insert (	3024   23 20 5 f  76	3000 ));
/* default operators int8 */
DATA(insert (	3024   20 20 1 f  412	3000 ));
DATA(insert (	3024   20 20 2 f  414	3000 ));
DATA(insert (	3024   20 20 3 f  410	3000 ));
DATA(insert (	3024   20 20 4 f  415	3000 ));
DATA(insert (	3024   20 20 5 f  413	3000 ));
/* crosstype operators int82 */
DATA(insert (	3024   20 21 1 f  1870	3000 ));
DATA(insert (	3024   20 21 2 f  1872	3000 ));
DATA(insert (	3024   20 21 3 f  1868	3000 ));
DATA(insert (	3024   20 21 4 f  1873	3000 ));
DATA(insert (	3024   20 21 5 f  1871	3000 ));
/* crosstype operators int84 */
DATA(insert (	3024   20 23 1 f  418	3000 ));
DATA(insert (	3024   20 23 2 f  420	3000 ));
DATA(insert (	3024   20 23 3 f  416	3000 ));
DATA(insert (	3024   20 23 4 f  430	3000 ));
DATA(insert (	3024   20 23 5 f  419	3000 ));

/*
 *	hierarchical oid_ops
 */

DATA(insert (	3029   26 26 1 f  609	3000 ));
DATA(insert (	3029   26 26 2 f  611	3000 ));
DATA(insert (	3029   26 26 3 f  607	3000 ));
DATA(insert (	3029   26 26 4 f  612	3000 ));
DATA(insert (	3029   26 26 5 f  610	3000 ));

/*
 * hierarchical tid_ops
 */

DATA(insert (	3039   27 27 1 f 2799	3000 ));
DATA(insert (	3039   27 27 2 f 2801	3000 ));
DATA(insert (	3039   27 27 3 f 387	3000 ));
DATA(insert (	3039   27 27 4 f 2802	3000 ));
DATA(insert (	3039   27 27 5 f 2800	3000 ));

/*
 *	hierarchical oidvector_ops
 */

DATA(insert (	3030   30 30 1 f  645	3000 ));
DATA(insert (	3030   30 30 2 f  647	3000 ));
DATA(insert (	3030   30 30 3 f  649	3000 ));
DATA(insert (	3030   30 30 4 f  648	3000 ));
DATA(insert (	3030   30 30 5 f  646	3000 ));

/*
 *	hierarchical float_ops
 */

/* default operators float4 */
DATA(insert (	3022   700 700 1 f	622 3000 ));
DATA(insert (	3022   700 700 2 f	624 3000 ));
DATA(insert (	3022   700 700 3 f	620 3000 ));
DATA(insert (	3022   700 700 4 f	625 3000 ));
DATA(insert (	3022   700 700 5 f	623 3000 ));
/* crosstype operators float48 */
DATA(insert (	3022   700 701 1 f	1122 3000 ));
DATA(insert (	3022   700 701 2 f	1124 3000 ));
DATA(insert (	3022   700 701 3 f	1120 3000 ));
DATA(insert (	3022   700 701 4 f	1125 3000 ));
DATA(insert (	3022   700 701 5 f	1123 3000 ));
/* default operators float8 */
DATA(insert (	3022   701 701 1 f	672 3000 ));
DATA(insert (	3022   701 701 2 f	673 3000 ));
DATA(insert (	3022   701 701 3 f	670 3000 ));
DATA(insert (	3022   701 701 4 f	675 3000 ));
DATA(insert (	3022   701 701 5 f	674 3000 ));
/* crosstype operators float84 */
DATA(insert (	3022   701 700 1 f	1132 3000 ));
DATA(insert (	3022   701 700 2 f	1134 3000 ));
DATA(insert (	3022   701 700 3 f	1130 3000 ));
DATA(insert (	3022   701 700 4 f	1135 3000 ));
DATA(insert (	3022   701 700 5 f	1133 3000 ));

/*
 *	hierarchical char_ops
 */

DATA(insert (	3020   18 18 1 f  631	3000 ));
DATA(insert (	3020   18 18 2 f  632	3000 ));
DATA(insert (	3020   18 18 3 f 92	3000 ));
DATA(insert (	3020   18 18 4 f  634	3000 ));
DATA(insert (	3020   18 18 5 f  633	3000 ));

/*
 *	hierarchical name_ops
 */

DATA(insert (	3027   19 19 1 f  660	3000 ));
DATA(insert (	3027   19 19 2 f  661	3000 ));
DATA(insert (	3027   19 19 3 f	93	3000 ));
DATA(insert (	3027   19 19 4 f  663	3000 ));
DATA(insert (	3027   19 19 5 f  662	3000 ));

/*
 *	hierarchical text_ops
 */

DATA(insert (	3031   25 25 1 f  664	3000 ));
DATA(insert (	3031   25 25 2 f  665	3000 ));
DATA(insert (	3031   25 25 3 f	98	3000 ));
DATA(insert (	3031   25 25 4 f  667	3000 ));
DATA(insert (	3031   25 25 5 f  666	3000 ));

/*
 *	hierarchical bpchar_ops
 */

DATA(insert (	3018   1042 1042 1 f 1058	3000 ));
DATA(insert (	3018   1042 1042 2 f 1059	3000 ));
DATA(insert (	3018   1042 1042 3 f 1054	3000 ));
DATA(insert (	3018   1042 1042 4 f 1061	3000 ));
DATA(insert (	3018   1042 1042 5 f 1060	3000 ));

/*
 *	hierarchical bytea_ops
 */

DATA(insert (	3019   17 17 1 f 1957	3000 ));
DATA(insert (	3019   17 17 2 f 1958	3000 ));
DATA(insert (	3019   17 17 3 f 1955	3000 ));
DATA(insert (	3019   17 17 4 f 1960	3000 ));
DATA(insert (	3019   17 17 5 f 1959	3000 ));

/*
 *	hierarchical abstime_ops
 */

DATA(insert (	3014   702 702 1 f  562	3000 ));
DATA(insert (	3014   702 702 2 f  564	3000 ));
DATA(insert (	3014   702 702 3 f  560	3000 ));
DATA(insert (	3014   702 702 4 f  565	3000 ));
DATA(insert (	3014   702 702 5 f  563	3000 ));

/*
 *	hierarchical datetime_ops
 */

/* default operators date */
DATA(insert (	3021   1082 1082 1 f 1095	3000 ));
DATA(insert (	3021   1082 1082 2 f 1096	3000 ));
DATA(insert (	3021   1082 1082 3 f 1093	3000 ));
DATA(insert (	3021   1082 1082 4 f 1098	3000 ));
DATA(insert (	3021   1082 1082 5 f 1097	3000 ));
/* crosstype operators vs timestamp */
DATA(insert (	3021   1082 1114 1 f 2345	3000 ));
DATA(insert (	3021   1082 1114 2 f 2346	3000 ));
DATA(insert (	3021   1082 1114 3 f 2347	3000 ));
DATA(insert (	3021   1082 1114 4 f 2348	3000 ));
DATA(insert (	3021   1082 1114 5 f 2349	3000 ));
/* crosstype operators vs timestamptz */
DATA(insert (	3021   1082 1184 1 f 2358	3000 ));
DATA(insert (	3021   1082 1184 2 f 2359	3000 ));
DATA(insert (	3021   1082 1184 3 f 2360	3000 ));
DATA(insert (	3021   1082 1184 4 f 2361	3000 ));
DATA(insert (	3021   1082 1184 5 f 2362	3000 ));
/* default operators timestamp */
DATA(insert (	3021   1114 1114 1 f 2062	3000 ));
DATA(insert (	3021   1114 1114 2 f 2063	3000 ));
DATA(insert (	3021   1114 1114 3 f 2060	3000 ));
DATA(insert (	3021   1114 1114 4 f 2065	3000 ));
DATA(insert (	3021   1114 1114 5 f 2064	3000 ));
/* crosstype operators vs date */
DATA(insert (	3021   1114 1082 1 f 2371	3000 ));
DATA(insert (	3021   1114 1082 2 f 2372	3000 ));
DATA(insert (	3021   1114 1082 3 f 2373	3000 ));
DATA(insert (	3021   1114 1082 4 f 2374	3000 ));
DATA(insert (	3021   1114 1082 5 f 2375	3000 ));
/* crosstype operators vs timestamptz */
DATA(insert (	3021   1114 1184 1 f 2534	3000 ));
DATA(insert (	3021   1114 1184 2 f 2535	3000 ));
DATA(insert (	3021   1114 1184 3 f 2536	3000 ));
DATA(insert (	3021   1114 1184 4 f 2537	3000 ));
DATA(insert (	3021   1114 1184 5 f 2538	3000 ));
/* default operators timestamptz */
DATA(insert (	3021   1184 1184 1 f 1322	3000 ));
DATA(insert (	3021   1184 1184 2 f 1323	3000 ));
DATA(insert (	3021   1184 1184 3 f 1320	3000 ));
DATA(insert (	3021   1184 1184 4 f 1325	3000 ));
DATA(insert (	3021   1184 1184 5 f 1324	3000 ));
/* crosstype operators vs date */
DATA(insert (	3021   1184 1082 1 f 2384	3000 ));
DATA(insert (	3021   1184 1082 2 f 2385	3000 ));
DATA(insert (	3021   1184 1082 3 f 2386	3000 ));
DATA(insert (	3021   1184 1082 4 f 2387	3000 ));
DATA(insert (	3021   1184 1082 5 f 2388	3000 ));
/* crosstype operators vs timestamp */
DATA(insert (	3021   1184 1114 1 f 2540	3000 ));
DATA(insert (	3021   1184 1114 2 f 2541	3000 ));
DATA(insert (	3021   1184 1114 3 f 2542	3000 ));
DATA(insert (	3021   1184 1114 4 f 2543	3000 ));
DATA(insert (	3021   1184 1114 5 f 2544	3000 ));

/*
 *	hierarchical time_ops
 */

DATA(insert (	3032   1083 1083 1 f 1110	3000 ));
DATA(insert (	3032   1083 1083 2 f 1111	3000 ));
DATA(insert (	3032   1083 1083 3 f 1108	3000 ));
DATA(insert (	3032   1083 1083 4 f 1113	3000 ));
DATA(insert (	3032   1083 1083 5 f 1112	3000 ));

/*
 *	hierarchical timetz_ops
 */

DATA(insert (	3033   1266 1266 1 f 1552	3000 ));
DATA(insert (	3033   1266 1266 2 f 1553	3000 ));
DATA(insert (	3033   1266 1266 3 f 1550	3000 ));
DATA(insert (	3033   1266 1266 4 f 1555	3000 ));
DATA(insert (	3033   1266 1266 5 f 1554	3000 ));

/*
 *	hierarchical interval_ops
 */

DATA(insert (	3025   1186 1186 1 f 1332	3000 ));
DATA(insert (	3025   1186 1186 2 f 1333	3000 ));
DATA(insert (	3025   1186 1186 3 f 1330	3000 ));
DATA(insert (	3025   1186 1186 4 f 1335	3000 ));
DATA(insert (	3025   1186 1186 5 f 1334	3000 ));

/*
 *	hierarchical macaddr
 */

DATA(insert (	3026   829 829 1 f 1222 3000 ));
DATA(insert (	3026   829 829 2 f 1223 3000 ));
DATA(insert (	3026   829 829 3 f 1220 3000 ));
DATA(insert (	3026   829 829 4 f 1225 3000 ));
DATA(insert (	3026   829 829 5 f 1224 3000 ));

/*
 *	hierarchical network
 */

DATA(insert (	3023   869 869 1 f 1203 3000 ));
DATA(insert (	3023   869 869 2 f 1204 3000 ));
DATA(insert (	3023   869 869 3 f 1201 3000 ));
DATA(insert (	3023   869 869 4 f 1206 3000 ));
DATA(insert (	3023   869 869 5 f 1205 3000 ));

/*
 *	hierarchical numeric
 */

DATA(insert (	3028   1700 1700 1 f 1754	3000 ));
DATA(insert (	3028   1700 1700 2 f 1755	3000 ));
DATA(insert (	3028   1700 1700 3 f 1752	3000 ));
DATA(insert (	3028   1700 1700 4 f 1757	3000 ));
DATA(insert (	3028   1700 1700 5 f 1756	3000 ));

/*
 *	hierarchical bool
 */

DATA(insert (	3017   16 16 1 f 58	3000 ));
DATA(insert (	3017   16 16 2 f 1694	3000 ));
DATA(insert (	3017   16 16 3 f 91	3000 ));
DATA(insert (	3017   16 16 4 f 1695	3000 ));
DATA(insert (	3017   16 16 5 f 59	3000 ));

/*
 *	hierarchical bit
 */

DATA(insert (	3016   1560 1560 1 f 1786	3000 ));
DATA(insert (	3016   1560 1560 2 f 1788	3000 ));
DATA(insert (	3016   1560 1560 3 f 1784	3000 ));
DATA(insert (	3016   1560 1560 4 f 1789	3000 ));
DATA(insert (	3016   1560 1560 5 f 1787	3000 ));

/*
 *	hierarchical varbit
 */

DATA(insert (	3034   1562 1562 1 f 1806	3000 ));
DATA(insert (	3034   1562 1562 2 f 1808	3000 ));
DATA(insert (	3034   1562 1562 3 f 1804	3000 ));
DATA(insert (	3034   1562 1562 4 f 1809	3000 ));
DATA(insert (	3034   1562 1562 5 f 1807	3000 ));

/*
 *	hierarchical text pattern
 */

DATA(insert (	3035   25 25 1 f 2314	3000 ));
DATA(insert (	3035   25 25 2 f 2315	3000 ));
DATA(insert (	3035   25 25 3 f 2316	3000 ));
DATA(insert (	3035   25 25 4 f 2317	3000 ));
DATA(insert (	3035   25 25 5 f 2318	3000 ));

/*
 *	hierarchical bpchar pattern
 */

DATA(insert (	3036   1042 1042 1 f 2326	3000 ));
DATA(insert (	3036   1042 1042 2 f 2327	3000 ));
DATA(insert (	3036   1042 1042 3 f 2328	3000 ));
DATA(insert (	3036   1042 1042 4 f 2329	3000 ));
DATA(insert (	3036   1042 1042 5 f 2330	3000 ));

/*
 *	hierarchical name pattern
 */

DATA(insert (	3037   19 19 1 f 2332	3000 ));
DATA(insert (	3037   19 19 2 f 2333	3000 ));
DATA(insert (	3037   19 19 3 f 2334	3000 ));
DATA(insert (	3037   19 19 4 f 2335	3000 ));
DATA(insert (	3037   19 19 5 f 2336	3000 ));

/*
 *	hierarchical money_ops
 */

DATA(insert (	3038   790 790 1 f	902 3000 ));
DATA(insert (	3038   790 790 2 f	904 3000 ));
DATA(insert (	3038   790 790 3 f	900 3000 ));
DATA(insert (	3038   790 790 4 f	905 3000 ));
DATA(insert (	3038   790 790 5 f	903 3000 ));

/*
 *	hierarchical reltime_ops
 */

DATA(insert (	3040   703 703 1 f	568 3000 ));
DATA(insert (	3040   703 703 2 f	570 3000 ));
DATA(insert (	3040   703 703 3 f	566 3000 ));
DATA(insert (	3040   703 703 4 f	571 3000 ));
DATA(insert (	3040   703 703 5 f	569 3000 ));

/*
 *	hierarchical tinterval_ops
 */

DATA(insert (	3041   704 704 1 f	813 3000 ));
DATA(insert (	3041   704 704 2 f	815 3000 ));
DATA(insert (	3041   704 704 3 f	811 3000 ));
DATA(insert (	3041   704 704 4 f	816 3000 ));
DATA(insert (	3041   704 704 5 f	814 3000 ));

/*
 *	hierarchical array_ops
 */

DATA(insert (	3015   2277 2277 1 f 1072	3000 ));
DATA(insert (	3015   2277 2277 2 f 1074	3000 ));
DATA(insert (	3015   2277 2277 3 f 1070	3000 ));
DATA(insert (	3015   2277 2277 4 f 1075	3000 ));
DATA(insert (	3015   2277 2277 5 f 1073	3000 ));

/*
 * hierarchical uuid_ops
 */

DATA(insert (	3042  2950 2950 1 f 2974	3000 ));
DATA(insert (	3042  2950 2950 2 f 2976	3000 ));
DATA(insert (	3042  2950 2950 3 f 2972	3000 ));
DATA(insert (	3042  2950 2950 4 f 2977	3000 ));
DATA(insert (	3042  2950 2950 5 f 2975	3000 ));

/*
 * hierarchical enum_ops
 */
DATA(insert (	3043   3500 3500 1	f	3518	3000 ));
DATA(insert (	3043   3500 3500 2	f	3520	3000 ));
DATA(insert (	3043   3500 3500 3	f	3516	3000 ));
DATA(insert (	3043   3500 3500 4	f	3521	3000 ));
DATA(insert (	3043   3500 3500 5	f	3519	3000 ));

/*
 * hierarchical tsvector_ops
 */
DATA(insert (	3044   3614 3614 1 f   3627 3000 ));
DATA(insert (	3044   3614 3614 2 f   3628 3000 ));
DATA(insert (	3044   3614 3614 3 f   3629 3000 ));
DATA(insert (	3044   3614 3614 4 f   3631 3000 ));
DATA(insert (	3044   3614 3614 5 f   3632 3000 ));


/*
 * hierarchical tsquery_ops
 */
DATA(insert (	3045   3615 3615 1 f   3674 3000 ));
DATA(insert (	3045   3615 3615 2 f   3675 3000 ));
DATA(insert (	3045   3615 3615 3 f   3676 3000 ));
DATA(insert (	3045   3615 3615 4 f   3678 3000 ));
DATA(insert (	3045   3615 3615 5 f   3679 3000 ));

...
DATA(insert (	3000		array_ops			PGNSP PGUID  3015 2277 t 0 ));
DATA(insert (	3000		abstime_ops			PGNSP PGUID  3014  702 t 0 ));
DATA(insert (	3000		bit_ops				PGNSP PGUID  3016 1560 t 0 ));
DATA(insert (	3000		bool_ops			PGNSP PGUID  3017   16 t 0 ));
DATA(insert (	3000		bpchar_ops			PGNSP PGUID  3018 1042 t 0 ));
DATA(insert (	3000		bytea_ops			PGNSP PGUID  3019   17 t 0 ));
DATA(insert (	3000		char_ops			PGNSP PGUID  3020   18 t 0 ));
DATA(insert (	3000		cidr_ops			PGNSP PGUID 3023  869 f 0 ));
DATA(insert (	3000		date_ops			PGNSP PGUID  3024 1082 t 0 ));
DATA(insert (	3000		float4_ops			PGNSP PGUID 3022  700 t 0 ));
DATA(insert (	3000		float8_ops			PGNSP PGUID 3022  701 t 0 ));
DATA(insert (	3000		inet_ops			PGNSP PGUID 3023  869 t 0 ));
DATA(insert OID = 3015 ( 3000	int2_ops	PGNSP PGUID 3024   21 t 0 ));
#define INT2_HIERARCHICAL_OPS_OID 3015
DATA(insert OID = 3016 ( 3000	int4_ops	PGNSP PGUID 3024   23 t 0 ));
#define INT4_HIERARCHICAL_OPS_OID 3016
DATA(insert (	3000		int8_ops			PGNSP PGUID 3024   20 t 0 ));
DATA(insert (	3000		interval_ops		PGNSP PGUID 3025 1186 t 0 ));
DATA(insert (	3000		macaddr_ops			PGNSP PGUID 3026  829 t 0 ));
DATA(insert (	3000		name_ops			PGNSP PGUID 3027   19 t 0 ));
DATA(insert (	3000		numeric_ops			PGNSP PGUID 3028 1700 t 0 ));
DATA(insert OID = 3017 ( 3000	oid_ops		PGNSP PGUID 3029   26 t 0 ));
#define OID_HIERARCHICAL_OPS_OID 3017
DATA(insert (	3000		oidvector_ops		PGNSP PGUID 3030   30 t 0 ));
DATA(insert (	3000		text_ops			PGNSP PGUID 3031   25 t 0 ));
DATA(insert (	3000		time_ops			PGNSP PGUID 3032 1083 t 0 ));
DATA(insert (	3000		timestamptz_ops		PGNSP PGUID  3021 1184 t 0 ));
DATA(insert (	3000		timetz_ops			PGNSP PGUID 3033 1266 t 0 ));
DATA(insert (	3000		varbit_ops			PGNSP PGUID 3034 1562 t 0 ));
DATA(insert (	3000		varchar_ops			PGNSP PGUID 3031   25 f 0 ));
DATA(insert (	3000		timestamp_ops		PGNSP PGUID  3021 1114 t 0 ));
DATA(insert (	3000		text_pattern_ops	PGNSP PGUID 3035   25 f 0 ));
DATA(insert (	3000		varchar_pattern_ops PGNSP PGUID 3035   25 f 0 ));
DATA(insert (	3000		bpchar_pattern_ops	PGNSP PGUID 3036 1042 f 0 ));
DATA(insert (	3000		name_pattern_ops	PGNSP PGUID 3037   19 f 0 ));
DATA(insert (	3000		money_ops			PGNSP PGUID 3038  790 t 0 ));
DATA(insert (	3000		tid_ops				PGNSP PGUID 3039   27 t 0 ));
DATA(insert (	3000		reltime_ops			PGNSP PGUID 3040  703 t 0 ));
DATA(insert (	3000		tinterval_ops		PGNSP PGUID 3041  704 t 0 ));
DATA(insert (	3000		uuid_ops			PGNSP PGUID 3042  2950 t 0 ));
DATA(insert (	3000		enum_ops			PGNSP PGUID 3043  3500 t 0 ));
DATA(insert (	3000		tsvector_ops		PGNSP PGUID 3044  3614 t 0 ));
DATA(insert (	3000		tsquery_ops			PGNSP PGUID 3045  3615 t 0 ));

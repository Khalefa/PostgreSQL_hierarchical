...
DATA(insert OID = 3000 (  hierarchical	5 1 t t t t t t f t hr_insert hr_beginscan hr_gettuple hr_getmulti hr_rescan hr_endscan hr_markpos hr_restrpos hr_build hr_bulkdelete hr_vacuumcleanup hr_costestimate hr_options ));
DESCR("Hierarchical index access method");
#define HIERARCHICAL_AM_OID 3000
